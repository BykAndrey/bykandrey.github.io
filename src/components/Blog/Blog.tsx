...
class Blog extends React.Component<object, State, object> {
    ...
    async initialiazation(statisticName: string, year: number) {
        ...
        this.setState({
            ...
            perfectValue: minMaxValue.min + (minMaxValue.max - minMaxValue.min) / 2,
            uiSettings: uiStatisticSettings[statisticName],
            mapData,
            charts,
            countryChartData: [],
    ...
    componentDidMount(): void {
        this.initialiazation(this.state.statisticName, this.state.year)
    }
        ...
        return (
            <div className={st.container}>
                ...
                {!this.state.selectedCounty && (
                    ...
                    {this.state.isShowListStatistic ? 'Hide statistic list ' : 'Hide statistic list'}
                </button>
                )}
